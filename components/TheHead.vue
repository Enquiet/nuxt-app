<template>
  <header class="header">
    <div class="container header__wrapper">
      ...
      <a class="header__cart" @click.prevent="setStatusCatrActive(true)">
        ...
        <span class="header__count" aria-label="Количество товаров" v-if="productsCard.length">{{productsCard.length}}</span>
      </a>
     </div>
  </header>
</template>
...
export default {
  computed :{
    ...mapState('cart', ['productsCard', 'cartActive'])
  },
  methods:{
